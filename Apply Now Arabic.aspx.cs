...
namespace _5adamtna
{
    public partial class Apply_Now_Arabic : System.Web.UI.Page
    {
        ...
        protected void btnDone_Click(object sender, EventArgs e)
        {
            ...
            string DateOfDeliver = System.DateTime.Now.AddDays(3).ToShortDateString();
            // Create a Connection
            ...
            //}
            string display = "شكرا لتسجيلك,من فضلك تأكد من بريدك الالكترونى اذا وافق عليه عليك طباعة الايصال من الموقع";
